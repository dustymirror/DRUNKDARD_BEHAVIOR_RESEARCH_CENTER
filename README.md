...
**Drunkard Behavior Research Center（醉汉行为研究中心）** 是一个运行于 **EuroPi** 上的实验性生成式 CV 乐器。
...
边界成为行为的一部分。当对象到达边缘时，会与墙壁发生反应，而不是简单穿过边界。
