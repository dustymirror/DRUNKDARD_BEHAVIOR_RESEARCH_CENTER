...
When in the current mode, it is advisable to set the Link value extremely low; otherwise, the dunkards are likely to end up in a prolonged pair-dance manoeuvre. However, you could also still use mid-high Link value to turn them into a pair of chaotic trajectory generators.
